			...
			<article class="helvetica pb5">
				<header class="vh-80 dt w-100">
					<div class="dtc pt5 v-mid cover ph3 ph4-m ph5-l">
						...
						<h2 class="f4 f2-ns  measure lh-title fw7">
							Hello, my name is Ebrima. I am a product engineer, DJ, and
							creative director working out of LA and DC. Most of my work
							focuses on building things, solving problems and pushing
							boundaries to bridge the gap between technology, music and
				...
				<header class="dt w-100">
					<div class="dtc cover ph3 ph4-m ph5-l">
						...
						<p>
							Upcoming event discovery/ticketing project to create experiences
							to discover culture through safe and inclusive spaces for and by
							the community.
						</p>
						<h2 class="f4 f2-ns measure lh-title fw7">
						...
						<p>
							...
							music and finance, Clouty is the world's first music futures
							trading platform.
						</p>
						<h2 class="f4 f2-ns  measure lh-title fw7">
